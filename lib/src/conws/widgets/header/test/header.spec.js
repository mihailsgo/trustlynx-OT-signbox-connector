  ...
  describe('HeaderView', function () {
    ...
    describe('view creation', function () {
      ...
      describe('... succeeds', function () {
        ...
        it('... and the model is initialized correctly', function () {
          ...
          expect(
              iconView.iconModel instanceof HeaderIconModel
          ).toBeTruthy();
          expect(
            iconView.iconModel.get('id')
          ).toBe(4711);
        });
      });
    });
    ...
    describe('view renders', function () {
      ...
      it('... correctly without configuration..', function (done) {
        ...
        TestUtil.run(done, function () {
          ...
          expect(view.$(
            ...
            1);
          expect(view.$(
            '.conws-header-wrapper .conws-header-toolbar .conws-delayedActionsToolbar li[data-csui-command=emaillink]').length).toBe(
            1);
      ...
      describe('... with different image edit actions', function () {
        ...
        it('... image edit elements available as all actions are available', function (done) {
          ...
          TestManager.fetch(done,view, view.model.get('id'));
          TestUtil.run(done,function () {
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > div.conws-header-edit').length).toBe(1);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').length).toBe(1);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').attr('accept')).toBe(
        ...
        it('... image edit elements available as some actions are available', function (done) {
          ...
          TestUtil.run(done,function () {
            ...
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').attr('accept')).toBe(
                'image/gif, image/x-png, image/jpeg, image/pjpeg, image/png, image/svg+xml');
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > img').length).toBe(0);
            expect(view.$('div .header-editor > span').length).toBe(1);
          });
        });
        ...
        it('... image edit elements not available as no actions are available', function (done) {
          ...
          TestManager.fetch(done,view, view.model.get('id'));
          TestUtil.run(done,function () {
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > .header-image > img').length).toBe(1);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > a').length).toBe(0);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').length).toBe(0);
          });
        });
        ...
        it('... image upload filetypes are restricted in configuration', function (done) {
          ...
          TestUtil.run(done,function () {
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > div.conws-header-edit').length).toBe(1);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').length).toBe(1);
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > input').attr('accept')).toBe('image/png');
            expect(view.$('.conws-header-image > .conws-workspace-icon-view > img').length).toBe(0);
          });
        });
      });
    ...
    describe('view private function ', function () {
      ...
      it('... \'renderPopover\' renders the popover view correctly', function (done) {
        ...
        TestManager.fetch(done,view, view.model.get('id'));
        TestUtil.run(done,function () {
          var ret = iconView.renderPopover();
    ...
    describe('model changes ', function () {
      ...
      it('...node model changes are observed by the view', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          expect(TestManager.iconView.iconModel.get('id')).toBe(4711);
        });
        ...
        TestUtil.run(done,function () {
          ...
          expect(TestManager.iconView.iconModel.get('id')).toBe(815);
        });
      });
      ...
      it('...node model changes are ignored on sub-type changes by the view', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          nodeModel.set({'id': 815, 'type': 0, volume_id: 4711,
            'data': {
              'bwsinfo': {
                'id': 4711
              }
    ...
    xdescribe('header view can be navigated with keyboard', function () {
      ...
      it('... with all view elements', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          window.tabelComment = commentEl = view.$("button.esoc-socialactions-comment-button");
