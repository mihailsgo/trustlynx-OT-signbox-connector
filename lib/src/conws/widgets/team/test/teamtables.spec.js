    ...
    describe('view renders', function () {
      ...
      it('a placeholder information for an empty team.', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          var ariaLabel = dataTable.attr('aria-label');
          expect(ariaLabel).toEqual("Participants");
      ...
      it('a team with just one empty role.', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          var rolesRows = view.$('#rolesview .csui-saved-item');
          expect(rolesRows.length).toEqual(1);
          var ariaLabelRoles = view.$('#rolesview .dataTable').attr('aria-label');
          expect(ariaLabelRoles).toEqual("Roles");
        });
      });
