    ...
    describe('view renders', function () {
      ...
      describe('collapsed view', function () {
        ...
        it('a placeholder information for an empty team.', function (done) {
          ...
          TestUtil.run(done,function () {
            expect(view.completeCollection.length).toEqual(0);
            var div = view.$('.cs-emptylist-container');
            expect(div.length).toEqual(1);
            expect(div.attr('class')).toEqual('cs-emptylist-container csui-collection-state csui-state-empty');
            var noResultMessageDiv = view.$('.cs-emptylist-container .cs-emptylist-text');
            expect(noResultMessageDiv.children().text()).toEqual(
                'There are no participants to display.');
            var noResultPlaceholderDiv = view.$('.cs-emptylist-container .cs-emptylist-placeholder');
            expect(noResultPlaceholderDiv.length).toBeGreaterThan(0);
          });
        });
      ...
      describe('expanded view', function () {
        ...
        it('with default configuration.', function (done) {
          ...
          TestUtil.run(done,function (done) {
            var expand = view.$('.csui-icon-v2__csui_action_expand32');
