  ...
  function (mockjax) {
    ...
    return {
      ...
      enable: function () {
        ...
        mockjax({
          url:'//server/otcs/cs/api/v2/nodes/628934?actions=docpreview&actions=default&actions=open&actions=download&actions=browse&fields=properties',
          responseText:{}
        })

        mockjax({
          url:'//server/otcs/cs/api/v1/nodes/628934/ancestors',
          responseText:{}
        })

        var responseText12345WithoutRelated = { "forms": [
          {
            "data": {
              "12345":{
                "12345_1": "Microsoft",
            ...
            "options": {
              "fields": {
                "12345":{
                  ...
                  "form": {
                    "attributes": {
                      "action": "api\/v1\/nodes\/19500\/categories\/12345",
                      "method": "PUT"
                    },
                    "renderForm": true
                  }
        ...
        var responseText12346WithoutRelated = { "forms": [
          {
            "data": {
              "12346": {
                "12346_1": "10002345",
            ...
            "options": {
              "fields": {
                "12346": {
                  ...
                  "form": {
                    "attributes": {
                      "action": "api\/v1\/nodes\/19500\/categories\/12346",
                      "method": "PUT"
                    },
                    "renderForm": true
                  }
        ...
        var responseText12347WithoutRelated = { "forms": [
          {
            "data": {
              "12347": {
                "12347_1": "MS",
            ...
            "options": {
              "fields": {
                ...
                "form": {
                  "attributes": {
                    "action": "api\/v1\/nodes\/19500\/categories\/12347",
                    "method": "PUT"
                  },
                  "renderForm": true
                }
        ...
        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12345%2C12345%2C12345%2C12345%2C12345%2C12345%2C12345%7D',
          responseText:responseText12345WithoutRelated
        })

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12345%7D',
          responseText:responseText12345WithoutRelated
        })

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12346%7D',
          responseText:responseText12346WithoutRelated
        })

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12347%7D',
          responseText:responseText12347WithoutRelated
        })

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12345%7D&where_rel_wksp_type_ids=%7B%7D&fields=related_items&where_rel_type=parent',
          responseText:responseText
        })
        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12345%2C12345%2C12345%2C12345%2C12345%2C12345%2C12345%7D&where_rel_wksp_type_ids=%7B%7D&fields=related_items&where_rel_type=parent',
          responseText:responseText
        });

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12347%7D&where_rel_wksp_type_ids=%7B%7D&fields=related_items&where_rel_type=parent',
          responseText:responseText12347
        });

        mockjax({
          url:'//server/otcs/cs/api/v2/forms/businessworkspaces/19500/metadata/update?where_category_ids=%7B12346%7D&where_rel_wksp_type_ids=%7B%7D&fields=related_items&where_rel_type=parent',
          responseText: responseText12346
        });

        mockjax({
          url: '//server/otcs/cs/api/v2/businessworkspaces/19500?metadata&fields=categories&include_icon=true*',
          responseTime: 50,
          responseText: {
            "links": {
              "self": {
                "body": "",
                "content_type": "",
                "href": "/api/v2/businessworkspaces/19500?metadata&fields=categories&include_icon=true",
                "method": "GET",
                "name": ""
              }
            },
              ...
              "actions": {
                "data":{
                  "delete-icon": {
                    ...
                    "content_type": "",
                    "form_href": "",
                    "href": "/api/v2/businessworkspaces/19500/icons",
                    "method": "DELETE",
                    "name": "Delete Icon"
                  },
                  "update-icon": {
