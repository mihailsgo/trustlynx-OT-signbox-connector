...
define([
  ...
  CommandModel, commands, SearchResultsView, TestUtils,
  WorkspacesColumns, AddRelatedWorkspacesSearch, lang, MockData) {
    'use strict';

    function isVisible(element, root) {
      return TestUtils.isElementVisible(element,root);
    }
    ...
    function testsetup(done,orderBy) {
      ...
      var tableColumns = new Backbone.Collection(WorkspacesColumns.toJSON());
      tableColumns.add(MockData.customTableColumns);
      var collection = {
        columns: columns,
        connector: connector,
        node: nodeModel,
        options: {
          query: {
            ...
            expand_users: "true",
            fields: "properties%7Bwnf_att_yw39_7%2Cwnf_att_yw39_6%2Cwnf_att_yw39_5%2Cwnf_att_yw39_3%2Cwnf_att_yw39_b%2Cwnf_att_yw39_8%2Cwnf_att_yw39_2%2Cwnf_att_yw39_9%2Cwnf_att_yw39_d%2Ctype%2Cname%2Csize%2Cmodify_date%2Cfavorite%2Cid%2Ctype_name%2Ccontainer%7D",
            limit: 30,
            page: 1,
            sort: "asc_name",
    ...
    describe('AddRwsTest', function () {
      ...
      describe('StandardViewTest', function () {
        ...
        it('paging bar is displayed correctly', function (done) {
          ...
          expect(pageBrowseElements.length).toEqual(5, "paging links");
          done();
        });
      ...
      describe('TableViewTest', function () {
        ...
        it('table view columns', function (done) {
          var stdcols = searchResultsView.targetView.tableCaptionView.$(".csui-table-column-text").text().trim();
          var custcols = _.pluck(_.pluck(searchResultsView.targetView.wrappedColumns,"attributes"),"name").join("");
          expect(stdcols+custcols).toEqual("NameSizeModifiedCountryCityStreetObject KeyStatusPostal CodeNumberIndustryStage");
          done();
        });
        ...
        describe('PageSelect', function () {
          ...
          it('select page', function (done) {
            ...
            }, "header to stay hidden, toolbar to stay visible").then(done.fail, function(){done();});
          });
