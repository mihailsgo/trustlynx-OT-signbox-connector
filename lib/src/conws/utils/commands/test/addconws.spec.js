...
define(['csui/lib/jquery', 'csui/lib/underscore',
  ...
  describe('Create Dialog test', function () {
    ...
    xdescribe("verify dialog elements for 'Contract Workspace'", function () {
    ...
    xdescribe("verify that save is failing with empty fields for 'Contract Workspace'", function () {
      ...
      it("cannot be saved with empty mandatory fields", function (done) {
        ...
        TestUtils.waitFor(function(){
          ...
          return htmlSaveErrorMessage.length>0;
        },'error message to appear').then(done,done.fail);
      });
