...
define(['csui/lib/jquery.mockjax', 'json!./nodestable.toolitems.result.json', 'json!./objectTypes.json',
], function (mockjax, nodeResults, objectTypes) {
  ...
  DataManager.test = {
    ...
    enable: function () {
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v2/nodes/101/doctemplates\\?subtypes'),
        responseText: {
          results: []
        }
      }));
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v1/nodes/[0-9]+/businessworkspacetypes'),
        responseText: {
          results: []
        }
      }));
      ...
      test1Mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/search/members/info?enterprise_slices=true',
        responseText: {
          results: []
        }
      }));
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v1/nodes/[0-9]+/nodes(?:\\?(.*))?'),
        responseText: {}
      }));

      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v1/nodes/[0-9]+/addablenodetypes'),
        responseText: {}
      }));
    },
