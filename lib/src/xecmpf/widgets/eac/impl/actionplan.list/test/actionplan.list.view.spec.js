...
define(['csui/lib/jquery',
...
], function ($, _, Backbone, Marionette, PageContext, NodeChildrenCollection, ActionPlanListView, mock) {
  describe('Actionplan list view ', function () {
    ...
    it('new model should be inserted in the collection on add action plan click', function () {
      ...
      expect(collectionLengthBeforeAdd).toEqual(collectionLengthAfterAdd);
    });
    xit('fetchEventActionPlans method shoud fetch action plans by making service call', function (done) {
