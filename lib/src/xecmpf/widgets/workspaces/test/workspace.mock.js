...
define(['csui/lib/underscore',
    ...
    'json!./kna1_0000003456.json'
], function (_, MockJax, BusWrksTypeKNA1, WrksAscNameKNA1,
             WrksDescNameKNA1, BusWrksTypeKNA2, WrksAscNameKNA2,
             WrksDescNameKNA2, BusWrksTypeKNA3, WrksAscNameKNA3,
             WrksDescNameKNA3, BusWrksTypeKNA4, WrksAscNameKNA4,
             WrksDescNameKNA4, BusWrksTypeKNA5, WrksAscNameKNA5,
             WrksDescNameKNA5, WrksEmpty, CreateForm,
             CreatedWorkspace, Categories, UpdateForm,
             NodesExpand, Auth, Facets, FieldProperties,
             Properties, Nodes, Actions, AddableNodeTypes,
             Ancestors, Members, MembersExpand, BusinessWorkspaces,
             Pulse, ObjectSocialInfo, MembersFavoritesTabs, kna1_0000003456) {
    ...
    return {
        ...
        enable: function () {
            ...
            mocks.push(MockJax({
                url: new RegExp('^//server/otcs/cs/api/v2/externalsystems/D9A/botypes/KNA1/boids/0000003456\\?limit='),
                responseText: kna1_0000003456
            }));
            ...
            mocks.push(MockJax({
                url: new RegExp('^//server/otcs/cs/api/v2/nodes/[0-9]+/nodes(?:\\?(.*))?'),
                responseText: FieldProperties
            }));

            mocks.push(MockJax({
                url: new RegExp('^//server/otcs/cs/api/v1/volumes/[0-9]+'),
                responseText: {
                    results: []
                }
            }));
