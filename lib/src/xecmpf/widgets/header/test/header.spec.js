...
define(['csui/lib/jquery', 'csui/lib/underscore', 'csui/lib/marionette',
  ...
  PageContext, Mock, TabbedPerspectiveView) {
  describe('Platform Header Widget', function () {
    var context, context2, contentRegion1, contentRegion2, perspectiveView1, perspectiveView2, header;
    ...
    describe('Header View without completeness check', function () {
      it('can be instantiated and rendered', function (done) {
        ...
        perspectiveView2 = new TabbedPerspectiveView(_.defaults({context: context2},
            perspectiveConfig));
