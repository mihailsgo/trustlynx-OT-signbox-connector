...
define(['require', 
  'nuc/lib/underscore', 'nuc/lib/marionette',
  ...
  describe('BlockingView', function () {
    ...
    describe('dark backgroud', function () {
      beforeEach(function (done) {
        ensureParentViewClass();
        parentView = new ParentView();
        parentView.darkBackground = true;
        BlockingView.imbue(parentView);
        parentView.render();
      ...
      it('verify dark background class added', function (done) {
        var blocker = parentView.$el.find('> .load-container');
        expect(blocker.length).toEqual(1);
        expect(blocker.hasClass('smart-loading-state-dark-theme')).toBeTruthy();
        done();
      });
    });
    ...
    describe('when made global and forced as the only blocking view', function () {
      ...
      beforeEach(function (done) {
        ...
        window.csui.requirejs.undef('smart/controls/progressblocker/blocker');

        ReloadedBlockingView = undefined;
        require(['smart/controls/progressblocker/blocker'], function () {
