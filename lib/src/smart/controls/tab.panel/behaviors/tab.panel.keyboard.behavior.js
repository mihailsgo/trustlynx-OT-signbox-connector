      ...
      _.extend(view, {
        ...
        _focusOnElement: function ($elem) {
          var elem = this.keyboardBehavior.tabableElements[this.currentTabPosition],
            tabEle = elem && elem._behaviors.length && elem._behaviors[0].tabableElements.filter(".cs-tablink");
          if (tabEle && tabEle.length) {
            tabEle.prop("tabindex", "-1");
          }
