...
define(['nuc/lib/underscore', 'nuc/lib/marionette', 'nuc/utils/base',
  'hbs!smart/controls/tab.panel/impl/tab.links',
  'smart/controls/tab.panel/impl/tab.link.view',
  'smart/controls/tab.panel/behaviors/tab.links.keyboard.behavior',
  ...
  var TabLinkCollectionView = Marionette.CompositeView.extend({
    ...
    childViewOptions: function (model, index) {
      return _.extend(this.options, {
        ...
        clickActivatingSemaphore: createClickActivatingSemaphore(this)
      });
    },
