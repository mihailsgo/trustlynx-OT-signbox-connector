...
'nuc/lib/marionette', 'smart/controls/progresspanel/impl/progresspanel/progresspanel.view',
...
'hbs!smart/controls/progresspanel/impl/progresspanel.ext'
  ...
  var ProgressPanelView = ProgressPanelViewImpl.extend({
    ...
    updateProgressArea: function (elem, info) {
      ...
      this.options.messageHelper.switchField(elem, ".csui-stateaction", info.state,
          BarStateValues);
      var isCustomisedExpression =  !!(this.itemsPending && this.itemsPending > 0) ||
    ...
    templateHelpers: function () {
      ...
      if (!this.options.hideGotoLocationSingleSet && !this.isMultiContainer && !config.enhancePanel) {
