...
define([
  'require', 'nuc/lib/moment', 'nuc/utils/types/date'
  ...
  function switchToUnknownServerTimeZone(done) {
    ...
    window.csui.requirejs.undef('nuc/utils/types/date');

    require(['nuc/utils/types/date'], function (date) {
      this.testDate = date;
      done();
    }.bind(this));
  }
  ...
  function switchToUTC(done) {
    ...
    window.csui.requirejs.undef('nuc/utils/types/date');
    require(['nuc/utils/types/date'], done);
  }
