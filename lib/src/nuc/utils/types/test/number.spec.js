...
define([
  'require', 'nuc/lib/underscore', 'nuc/utils/types/number', 'i18n'
  ...
  function switchToGerman(done) {
    ...
    window.csui.requirejs.undef('nuc/lib/numeral');
    window.csui.requirejs.undef('nuc/utils/types/number');

    require(['i18n', 'nuc/utils/types/number'], function (i18n, number) {
  ...
  function switchToOriginal(done) {
    ...
    window.csui.requirejs.undef('nuc/lib/numeral');
    window.csui.requirejs.undef('nuc/utils/types/number');
    require(['nuc/utils/types/number', 'nuc/lib/numeral'], done);
  }
