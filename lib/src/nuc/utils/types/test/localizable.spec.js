...
define([
  'require', 'nuc/lib/underscore', 'nuc/utils/types/localizable', 'i18n'
  ...
  function switchToTest(done) {
    ...
    window.csui.requirejs.undef('nuc/utils/types/localizable');

    require(['nuc/utils/types/localizable', 'i18n'], function (localizable, i18n) {
  ...
  function switchToGerman(done) {
    ...
    require(['i18n', 'nuc/utils/types/localizable'], function (i18n, localizable) {
      this.testLocalizable = localizable;
  ...
  function switchToOriginal(done) {
    ...
    window.csui.requirejs.undef('i18n');
    window.csui.requirejs.undef('nuc/utils/types/localizable');
    require(['nuc/utils/types/localizable'], done);
  }
  ...
  describe('localizable', function () {
    describe('getClosestLocalizedString', function () {
      ...
      it('returns always a string by stringifying primitive values', function () {
        ...
        expect(this.testLocalizable.getClosestLocalizedString(undefined)).toEqual('');
      });

      it('returns for undefined or null value either default value or empty string', function () {
        expect(this.testLocalizable.getClosestLocalizedString(undefined, 5)).toEqual('5');
        expect(this.testLocalizable.getClosestLocalizedString(undefined, 'MyTestDefVal')).toEqual('MyTestDefVal');
        expect(this.testLocalizable.getClosestLocalizedString(undefined, false)).toEqual('false');
        expect(this.testLocalizable.getClosestLocalizedString(undefined, undefined)).toEqual('');
        expect(this.testLocalizable.getClosestLocalizedString(undefined, null)).toEqual('');
        expect(this.testLocalizable.getClosestLocalizedString(null, '27')).toEqual('27');
        expect(this.testLocalizable.getClosestLocalizedString(null, null)).toEqual('');
        expect(this.testLocalizable.getClosestLocalizedString({ 'test-TEST': undefined }, undefined)).toEqual('');
      });
