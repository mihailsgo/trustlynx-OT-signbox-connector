...
define([
  ...
  return {
    enable: function () {
      ...
      mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v2/nodes/2009(?:\\?(.*))?$'),
        urlParams: ['query'],
        response: function (settings) {
          var parameters = parseParams(settings.urlParams.query);
          var actions = parameters.actions.reduce(function (result, signature) {
            result[signature] = {};
            return result;
          }, {});
          this.responseText = {
      ...
      mocks.push(mockjax({
        ...
        data: function (data) {
          ...
          return (body.reference_id === 2007 && body.ids[0] === 2007 && body.actions[0] === 'delete')
            ...
            || (body.ids[0] === 2001 && body.actions.length === 11)
            || (body.ids[0] === 2009 && body.actions.length === 1);
        },
        response: function (settings) {
