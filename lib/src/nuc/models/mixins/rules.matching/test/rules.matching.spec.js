...
define(['nuc/lib/underscore', 'nuc/lib/jquery', 'nuc/lib/backbone',
  ...
  describe('RulesMatchingMixin', function () {
    var DefaultActionModel, DefaultActionCollection, defaultActions, decidesOptions;
    ...
    beforeAll(function () {
      ...
      DefaultActionCollection = Backbone.Collection.extend({
        ...
        findByNode: function (node, options) {
          return this.find(function (item) {
            return item.matches(node, options);
          });
        }
      });
      ...
      defaultActions = new DefaultActionCollection([
        ...
        {
          decides: function (model, options) {
            decidesOptions = options;
    ...
    it('passes options to the decides function', function () {
      ...
      decidesOptions = undefined;
      expect(defaultActions.findByNode(node, options).get('signature')).toEqual('Disabled');
      expect(typeof decidesOptions).toEqual('object');
      expect(decidesOptions.test).toBe(true);
    });
