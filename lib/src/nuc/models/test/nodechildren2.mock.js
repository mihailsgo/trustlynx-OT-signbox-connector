...
define(['nuc/lib/underscore', 'nuc/lib/jquery.mockjax',
  'nuc/lib/jquery.parse.param', 'json!./nodechildren.data.json'
        ...
        links: {
          "data": {
            "self": {
              "body": "",
              "content_type": "",
              "href": "/api/v2/nodes/" + nodeId,
              "method": "GET"
            }
          }
        },
        results: {data: {properties: mocked.nodes[nodeId]}}
      };
    }
  };
  ...
  function mockV2NodeChildren() {
    return mockjax(nodechildren2);
  }

  function mockV2NodeDetails() {
    return mockjax(nodeDetalsV2);
  }
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockV2NodeChildren());
    },

    mockV2NodeChildren: mockV2NodeChildren,
    mockV2NodeDetails: mockV2NodeDetails,
