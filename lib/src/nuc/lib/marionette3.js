...
// * Use noConflict
// * Trigger the 'before:show' and "show" events on the region's view
// * for compatibility with Marionette 2.
...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['nuc/lib/backbone', 'nuc/lib/underscore', 'nuc/lib/radio'], factory) :
...
var Region = MarionetteObject.extend({
  ...
  show: function show(view, options) {
    ...
    // [OT] Trigger the 'before:show' event on the view for compatibility with Marionette 2.
    triggerMethodOn(view, 'before:show', view, options);
    ...
    // [OT] Trigger the 'before:show' event on the view for compatibility with Marionette 2.
    triggerMethodOn(view, 'show', view, options);
  ...
  _empty: function _empty(view, shouldDestroy) {
    // [OT] allow destroy of M2 views in M3 (LPAD-85060)
    if(!view) {
...
var Behavior = MarionetteObject.extend({
  ...
  proxyViewProperties: function proxyViewProperties(view) { // [OT] view parameter for Marionette 2
