...
define(['require', 'i18n'
  ...
  describe('i18n', function () {
    ...
    function unloadTestModules() {
      ...
      requirejs.undef('nuc/lib/test/nls/lang');
      requirejs.undef('nuc/lib/test/nls/root/lang');
      requirejs.undef('nuc/lib/test/nls/test/lang');
      requirejs.undef('i18n!nuc/lib/test/nls/lang');
      requirejs.undef('i18n!nuc/lib/test/nls/lang:preferred');
    }
    ...
    describe('by default', function () {
      ...
      beforeEach(function (done) {
        ...
        require(['i18n!nuc/lib/test/nls/lang'], function (lang) {
          testLang = lang;
          done();
        });
      }, 5000);
    ...
    describe('with the forced default', function () {
      ...
      beforeEach(function (done) {
        ...
        require(['i18n!nuc/lib/test/nls/lang:configured'], function (lang) {
          testLang = lang;
          done();
        });
      }, 5000);
    ...
    describe('with a specific locale', function () {
      ...
      beforeEach(function (done) {
        ...
        require(['i18n!nuc/lib/test/nls/test/lang'], function (lang) {
          testLang = lang;
          done();
        });
      }, 5000);
    ...
    describe('with a preferred locale', function () {
      ...
      beforeEach(function (done) {
        ...
        require(['i18n!nuc/lib/test/nls/lang:preferred'], function (lang) {
          testLang = lang;
          done();
        });
      }, 5000);
