...
define([
  'csui/lib/jquery', 'csui/lib/handlebars', 'csui/lib/binf/js/binf', 'csui/lib/moment'
], function ($, Handlebars, Bootstrap, moment) {
...
(function($) {
    ...
    Alpaca.registerMessages({
      ...
      "stringTooLong": "This field must contain at most {0} numbers or characters."
    });
...
(function($) {
    ...
    callbacks["collapsible"] = function()
    {
        ...
        var anchorEl = $("[data-binf-toggle='collapse']", legendEl);
