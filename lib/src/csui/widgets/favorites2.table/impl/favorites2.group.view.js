  ...
  var FavoriteGroupView = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      ...
      return {
        ...
        SaveEditTooltip: lang.addFavoriteAddButtonLabel,
    ...
    events: {
      ...
      'click @ui.deleteButton': function (event) {
        ...
        ModalAlertView.confirmQuestion(_.str.sformat(lang.deleteGroupConfirmationText, groupName),
            lang.deleteGroupConfirmationTitle, {buttons: ModalAlertView.OkCancel})
            .fail(function () {
              self._setFocus();
            })
            .done(function (arg) {
      ...
      'input @ui.nameInput': function (event) {
    ...
    _setFocus: function () {
      ...
      $(document).ready( function() {
        if (self.ui.groupNameButton.length) {
          self.ui.groupNameButton.trigger('focus');
        }
      });
    },
