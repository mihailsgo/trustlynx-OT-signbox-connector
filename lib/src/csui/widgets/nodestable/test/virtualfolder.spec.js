  ...
  describe('For VirtualFolder', function () {
    ...
    describe('NodeStable view', function () {
      ...
      beforeEach(function (done) {
        context && context.viewStateModel &&
      ...
      it('Filter icon is visible[Low]', function () {
        var filterButton = nodesTableView.$el.find('li[data-csui-command="filter"]' +
                                                   ' .csui-icon-v2__csui_action_filter32:not(.binf-hidden)');
      ...
      it('on click of filter icon shows the facet panel [Medium]', function (done) {
        ...
        var filterButton = nodesTableView.$el.find('li[data-csui-command="filter"] .csui-toolitem');
