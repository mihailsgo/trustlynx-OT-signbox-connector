...
define(['require', 'csui/lib/underscore', 'csui/lib/jquery', 'json!./permissions.data.json', 'csui/lib/jquery.mockjax' , 'json!./permissions.nonadmin.data.json'
  ...
  return {
    ...
    enable: function () {
      ...
      mockjax({
        url: '//server/otcs/cs/api/v2/members?limit=5&sort=asc_name&query=u&where_type=0&expand=properties%7Bgroup_id%2Cleader_id%7D&page=1',
        responseTime: 0,
        type: 'GET',
        responseText: {
          "results": [
      ...
      mockjax({
        url: '//server/otcs/cs/api/v2/members?limit=20&sort=asc_name&query=a&where_type=0&where_type=1&expand=properties%7Bgroup_id%2Cleader_id%7D&page=1',
        responseTime: 0,
        type: 'GET',
        responseText: {
          "results": [
  ...
  mockjax({
    url: "//server/otcs/cs/api/v2/members?expand=properties%7Bgroup_id%7D&limit=20&page=1&sort=asc_name",
    responseTime: 0,
    responseText: {
      "results": [
        {
  ...
  mockjax({
    url: "//server/otcs/cs/api/v2/members?where_type=1&expand=properties%7Bgroup_id%7D&limit=20&page=1&sort=asc_name",
    responseTime: 0,
    responseText: {
      "results": [{
        "data": {
