...
define(['csui/lib/underscore', 'csui/lib/jquery',
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/members\\?limit=10&sort=&query=u&where_type=0&where_type=1&expand=properties%7Bgroup_id%2Cleader_id%7D'),
        responseTime: 0,
        type: 'GET',
        responseText: {
          "collection": {
      ...
      mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/members\\?limit=10&sort=&query=a&where_type=0&where_type=1&expand=properties%7Bgroup_id%2Cleader_id%7D'),
        responseTime: 0,
        type: 'GET',
        responseText: {
          "collection": {
