  ...
  var WizardView = Marionette.LayoutView.extend({
    ...
    nextStep: function () {
      if (this.currentView.validate()) {
        if (!this.isLastStep()) {
          ...
          this.renderCurrentStep();
          this.handleFocus(FLOWS.FORWARD);
        } else {
          this.save();
        }
      }
    ...
    prevStep: function () {
      if (!this.isFirstStep()) {
        ...
        this.renderCurrentStep();
        this.handleFocus(FLOWS.BACKWARD);
      }
    },
