...
define(['csui/lib/underscore', 'csui/lib/jquery',
  'csui/lib/jquery.mockjax', 'csui/lib/jquery.parse.param', 'csui/lib/jquery.binary.ajax',
  'json!./tree.browse.data.json'
], function (_, $, mockjax, parseParam, binaryAjax, mocked) {
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v2/nodes/addablenodetypes'),
        responseText: {
          data: {},
          definitions: {}
        }
