...
define(['csui/lib/marionette', 'csui/utils/connector', 'csui/models/node/node.model',
  'csui/models/nodechildren', 'csui/controls/fileupload/fileupload', 'csui/utils/contexts/page/page.context',
  'csui/models/node.children2/node.children2',
  'csui/controls/globalmessage/globalmessage',
  './fileupload.mock.js'
], function (Marionette, Connector, NodeModel, NodeChildrenCollection, 
    fileUploadHelper, PageContext, NodeChildren2Collection, GlobalMessage, mock) {
  "use strict";

  describe('fileUploadHelper', function () {

    var container, collection, pageContext,
    view = mock.newView();
    beforeAll(function () {
      ...
      pageContext = new PageContext({ factories: { connector: connector } });
    ...
    it('succeeds uploading after the second (GET) server call', function (done) {
      var fileUploadController = fileUploadHelper.newUpload({container: container, context: pageContext, originatingView:view}),
    ...
    it('adds the new node to the target collection', function (done) {
      var children = new NodeChildrenCollection(undefined, {node: container}),
          fileUploadController = fileUploadHelper.newUpload({
            container: container,
            context: pageContext, originatingView:view,
            collection: children
          }),
          fileUploads = fileUploadController.uploadFiles;
