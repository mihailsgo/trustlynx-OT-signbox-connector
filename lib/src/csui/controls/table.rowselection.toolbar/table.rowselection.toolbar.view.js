  ...
  var TableRowSelectionToolbarView = Marionette.LayoutView.extend({
    ...
    initialize: function (options) {
      ...
      this.listenTo(this, 'toolbar:activity', function (toolbarVisible, headerVisible) {
        ...
        if (!toolbarVisible && this._selectedCountView) {
    ...
    _moveFocus: function () {
      ...
      var focusedEle = this._focusableElements.length > this._focusedToolbarItemIndex &&
        this._focusableElements[this._focusedToolbarItemIndex].parentElement,
        focusableIndex = this._toolbarView.$el.children().index(focusedEle);
      if (this._toolbarView) {
        this._toolbarView.setFocusByIndex(focusableIndex);
      }
    },

    setActive: function(isActive) {
      this._filteredToolItemsCollection.setActive(isActive);
      this._toolbarView.setActive(isActive);
    }
