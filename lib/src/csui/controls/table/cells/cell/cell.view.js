...
define([
  ...
  'csui/utils/focusable', 'i18n!csui/controls/table/impl/nls/lang'
], function (module, _, Marionette, focusable, lang) {
  'use strict';
    ...
    getValueText: function () {
      ...
      if (column) {
        ...
        if (value === null || value === undefined) {
          ...
          value = (columnName === 'order' && value === 0) ? lang.MasterCompoundDocumentLabel :
            value;
          if (columnName === 'order' && typeof value === "string") {
