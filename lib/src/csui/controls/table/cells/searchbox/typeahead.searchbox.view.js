...
define(['csui/lib/jquery',
  ...
  var TypeaheadSearchBoxView = SearchBoxView.extend({
    ...
    taFilterChanged: function (event) {
    ...
    constructor: function TypeaheadSearchBoxView(options) {
      ...
      if (!this.source) {
        throw new Error("typeahead.seachbox options require a source to be set");
      }
      else {
    ...
    _accessibility: function (item) {
      this.ui.searchInput.attr('aria-activedescendant', item.attr("id"));
      return;
    },
