...
define(['module','require',
  ...
  var UserCellView = TemplatedCellView.extend({
    ...
    getValueData: function () {
      var userType        = this.prepareUserType(),
          right_id_expand = this.model.get("right_id_expand"),
          right_id_type = (right_id_expand && right_id_expand.type),
          isOwner = (userType === 'owner'),
          isOwnerGroup = (userType === 'group'),
          isUser = (!isOwner && !isOwnerGroup && right_id_type === 0),
          isGroup = (userType === 'custom' && right_id_type === 1),
          isRole = (userType === 'custom' && right_id_type === 848),
          displayName = this.getDisplayName(),
          title = isOwner ? lang.ownerAccessTitle : isOwnerGroup ? lang.groupOwnerAccessTitle :
            isRole ? lang.roleAccessTitle : isGroup ? lang.groupAccessTile : isUser ? displayName : 'public',
          utAriaPattern = isOwner ? lang.ownerAria : isOwnerGroup ? lang.groupOwnerAria :
              isRole ? lang.roleAria : isGroup ? lang.groupAria : isUser ? lang.userAria : 'public',
          userTypeAria = _.str.sformat(utAriaPattern, displayName);
      ...
      return {
        ...
        isOwner: isOwner,
        userTypeAria: userTypeAria,
        isOwnerGroup: isOwnerGroup,
        isOwnerOrOwnerGroup: isOwner || isOwnerGroup,
