  ...
  var StatusCellView = TemplatedCellView.extend({
      ...
      getValueData: function () {
        var statusName = this._getStatusName(),
            icon = this.model.getStatusIcon && this.model.getStatusIcon();
      ...
      _getIcon: function () {
        var status = this.model.get(this.options.column.name + "_icon_name"),
            icon   = status ? 'icon-status-' + status : undefined;
        return icon;
      }
    },
    {
