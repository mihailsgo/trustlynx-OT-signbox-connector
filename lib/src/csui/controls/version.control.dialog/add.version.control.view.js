  ...
  var AddVersionControlView = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      var selectVersionlabel = _.str.sformat(lang.selectVersionlabel, this.fileName),
          majorVersionlabel = _.str.sformat(lang.majorVersionAria, this.latestMajor),
          minorVersionlabel = _.str.sformat(lang.minorVersionAria, this.latestMinor);
      return {
        ...
        majorVersionlabel: majorVersionlabel,
        minorVersionlabel: minorVersionlabel
      };
    },
