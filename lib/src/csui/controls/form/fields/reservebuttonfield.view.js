...
define([
  ...
  var ReserveButtonFieldView = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      ...
      var _canUnreserve = this.canUnreserve && this.reserved;
      ...
      return {
        ...
        tabIndex: tabIndex,
        canUnreserve: _canUnreserve,
        cannotUnreserve: !_canUnreserve,
        pressToUnreserve: _canUnreserve? lang.pressToUnreserve : this.getReserveBy()
      };
    },
    getReserveBy: function(){
      var reserveUser = "";
      if(this.reservedUser){
        reserveUser = _.str.sformat(lang.reservedBy, this.reservedUser.get('display_name'));
      }
      return reserveUser;
    },
    onRender: function () {
