...
define([
  ...
  var BooleanFieldView = FormFieldView.extend({
    ...
    onRender: function () {
      ...
      var isFieldDisabled = this.alpacaField && this.alpacaField.schema && this.alpacaField.schema.disabled ||
        this.model && this.model.get("schema") && this.model.get("schema").disabled;
