...
define(['module', 'csui/lib/underscore', 'csui/lib/jquery', 'csui/lib/backbone',
  'csui/lib/marionette', 'csui/lib/alpaca/js/alpaca.lite', 'csui/utils/types/number', 'csui/models/form',
  ...
  Alpaca.Fields.CsuiIntegerField = Alpaca.Fields.IntegerField.extend({
    ...
    showField: function () {
      ...
      this.schema.maximum = (!_.isUndefined(this.schema.maximum) && !_.isNull(this.schema.maximum)) && this.schema.maximum < Number.MAX_SAFE_INTEGER ?
                            this.schema.maximum : Number.MAX_SAFE_INTEGER;
      this.schema.minimum = (!_.isUndefined(this.schema.minimum) && !_.isNull(this.schema.minimum)) && this.schema.minimum > Number.MIN_SAFE_INTEGER ?
