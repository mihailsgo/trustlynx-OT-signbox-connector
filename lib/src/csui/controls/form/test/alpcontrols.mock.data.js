...
define(['csui/lib/jquery.mockjax'], function (mockjax) {
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/members\\?limit=20&sort=&query=a&where_type=0&expand=properties%7Bgroup_id%2Cleader_id%7D'),
        responseTime: 0,
        type: 'GET',
        responseText: {
          "collection": {
      ...
      mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/members\\?limit=20&sort=&query=d&where_type=0&expand=properties%7Bgroup_id%2Cleader_id%7D'),
        responseTime: 0,
        type: 'GET',
        responseText: {
          "collection": {
      ...
      mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/members\\?limit=20&sort=&query=(.*)&where_type=0&expand=properties%7Bgroup_id%2Cleader_id%7D'),
        responseTime: 0,
        type: 'GET',
        responseText: []
      }));
