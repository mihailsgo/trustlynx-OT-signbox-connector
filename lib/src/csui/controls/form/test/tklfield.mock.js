    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        ...
        response: function (settings) {
          if (!!settings.data.get('attribute_values')) {
            var attribute_values = JSON.parse(settings.data.get('attribute_values')),
                attribute_key    = settings.data.get('attribute_key'),
                parent           = mocked[attribute_key]["parent"];
            this.responseText = {};
            if(!!attribute_key) {
