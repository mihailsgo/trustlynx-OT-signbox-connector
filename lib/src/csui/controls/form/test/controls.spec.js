  ...
  describe("Form Controls", function () {
    ...
    describe("UserFieldView", function () {
      ...
      describe("rendered in DOM", function () {
        ...
        xit("should show list of autosuggested users on entering input", function (done) {
        ...
        xit("should show no results when there is no user", function (done) {
          writeField = userField.find('.picker-container input');
          writeField.val('xyz');
          writeField.trigger('keyup');
          TestUtils.asyncElement(userField,
    ...
    describe("TextAreaFieldView for description  and isTextareaAutoHeight is true ", function () {

      var tafId    = "tafID",
      tafVal1  = "tafVal1",
      tafLabel = "tafLabel",
      descriptionText = 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.';
      var textAreaField;
      ...
      beforeEach(function () {
        if (!textAreaField) {
          textAreaField = new TextAreaFieldView({
            ...
            alpaca: {
              options: {isTextareaAutoHeight:true}
            }
          });
      ...
      it("verifying csui-autoheight-textareafield class", function () {
        ...
        expect(textAreaField.$el.hasClass('csui-autoheight-textareafield')).toBeTruthy();
        textAreaField.setValue(descriptionText);
        ...
        expect(textAreaField.$el.css('height') !== 'auto').toBeTruthy();
      });

    });
    describe("TextAreaFieldView", function () {
      ...
      describe("rendered in DOM", function () {
        ...
        describe("a readable field", function () {
          ...
          it("having the focus: always shows the edit icon", function (done) {
            ...
            expect(textAreaField.getStatesBehavior().isWriteOnly()).toBeFalsy();
            expect(textAreaField.getEditableBehavior()._isEditIconVisible()).toBeFalsy();
            textAreaField.getEditableBehavior().ui.readField.trigger('mouseover');
        ...
        describe("a writeable field", function () {
          ...
          describe("can be made readable by", function () {
            ...
            it("clicking outside the field", function (done) {
              expect(textAreaField.getStatesBehavior().isStateRead()).toBeFalsy();
              expect(textAreaField.getStatesBehavior().isStateWrite()).toBeTruthy();
              textAreaField.getEditableBehavior().ui.writeField.trigger('focusout');
              expect(textAreaField.getStatesBehavior().isStateRead()).toBeTruthy();
              expect(textAreaField.getStatesBehavior().isStateWrite()).toBeFalsy();
              done();
            });
          ...
          xit("throws event when value has changed", function (done) {
          ...
          xit("shows its old value if cancel icon is clicked", function (done) {
            var newVal = "newVal",
                oldVal = "oldVal";
          ...
          xit("shows its old value if escape is pressed", function (done) {
            var newVal = "newVal",
                oldVal = "oldVal";
            textAreaField.setValue(oldVal);
            expect(textAreaField.getValue()).toEqual(oldVal);
