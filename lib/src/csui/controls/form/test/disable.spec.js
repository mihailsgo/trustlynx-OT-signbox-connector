...
define(["csui/lib/jquery",
  ...
  'use strict';
  describe("Disabled Form Fields", function () {
    ...
    describe("as a disabled field", function () {
      ...
      xit("must be focusable", function () {
      ...
      xit("must not display action icons on hovering multi value field", function () {
