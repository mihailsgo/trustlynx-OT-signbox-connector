...
], function ($, _, Backbone, Marionette, GlobalMessage, lang, base, TabableRegionBehavior, template, itemTemplate) {
  'use strict';
  ...
  var SummaryDescriptionView = Marionette.View.extend({
    ...
    templateContext: function () {
      ...
      return {
        ...
        backButtonAria: lang.SummaryDescriptionBackAria
      };
    },
    ...
    showSettingsView: function (event) {
      var data = new FormData(),
        summary_description = this.options.searchResultsView.headerView.data.summary_description;

      if (!!summary_description) {
        this.options.searchResultsView.blockActions();
        data.append('summary_description', summary_description);
        this.options.settings.save(null, {
          ...
          this.options.settingsView.trigger('update:showSummaryDescriptions');
          this.options.searchResultsView.collection.settings_changed = false;
