  ...
  var SortingView = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      ...
      return {
        ...
        sortByTooltip: _.str.sformat(lang.sortBy, self.selectedValue),
    ...
    constructor: function SortingView(options) {
      ...
      var state_order = this.collection.orderBy ? this.collection.orderBy.split(' ')[0] : 
        this.context && (this.context.viewStateModel.getViewState('order_by') && this.context.viewStateModel.getViewState('order_by').split('_')[0]);
    ...
    onSortOptionClick: function (event) {
      ...
      this.options.resultView.isSortOrderClicked = false;
    },
    ...
    onSortOrderClick: function (event) {
      ...
      this.options.resultView.isSortOrderClicked = true;
    },
    ...
    onRender: function () {
      var self = this,
          usePerfectScrollbar = PerfectScrollingBehavior.usePerfectScrollbar();
      ...
      self.ui.dropdownToggle.on('binf.dropdown.after.show', function () {
      if (!!usePerfectScrollbar) {
        self.ui.dropdown.addClass('csui-perfect-scrolling');
        self.ui.dropdown.perfectScrollbar({suppressScrollX: true, includePadding: true});
      } else {
        self.ui.dropdown.addClass('csui-normal-scrolling csui-no-scroll-x');
      }
    });
    }
  });
