...
define({
  ...
  ieFolderSupportError: 'Internet Explorer does not support dragging of folders',
  ...
  addVersionDenied: 'Unable to add version to {0}. Permissions required to add new content here.',
