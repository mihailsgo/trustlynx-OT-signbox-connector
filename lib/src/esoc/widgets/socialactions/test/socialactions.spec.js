...
define(['csui/lib/marionette', 'csui/lib/underscore', 'csui/lib/jquery',
  ...
  describe('Comment Widget', function () {
    ...
    describe('Get the comments', function () {
      ...
      it('Rendered comment widget', function () {
        expect(commentDialogView.$el.find('button.esoc-socialactions-comment-button')).toBeTruthy();
      });
      ...
      it('Click comment icon and open a list of comments', function (done) {
        $('button.esoc-socialactions-comment-button').trigger('click');
