...
csui.define({
  ...
  presenceOnlineTooltipText: 'Available',
  ...
  sidePanelCloseButton : "Close",
  lblLeave: 'Leave',
  txtLeaveContentMgt:'Leave page without enabling Content Manager mode?',
  hrdUnsaved: 'Unsaved changes',
  txtEnableContentMgt: 'The reason you have entered for enabling Content Manager mode has not been saved.  Save before continuing?',
  lblSave: 'Save',
  lblDiscard: 'Discard'
});
