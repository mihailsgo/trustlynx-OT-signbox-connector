      ...
      require(['esoc/widgets/socialactions/commentscollectionwidget', 'esoc/widgets/common/util'],
          function (CommentsCollectionWidget, CommonUtil) {
            ...
            if(status.originatingView){
              commentConfig.blockingParentView = status.originatingView;
              status.originatingView._blockingCounter<1 && status.originatingView.blockActions();
            }
            nodeModel.connector.makeAjaxCall({
              ...
              error: function (jqXHR, exception) {
                status.originatingView && status.originatingView.unblockActions();
