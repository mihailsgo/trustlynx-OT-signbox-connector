...
csui.define([
  ...
  /*
   Initializes the test manager. Sets the test
   managers context and the node id.
   */
  ...
  /*
   Prepares the required mock data.
   */
  ...
  TestManager.prepareDefaultData = function () {
    ...
    // create workspace roles and participants and members mock data
    //
    // Roles:
    // - Manager
    // - Staff
    ...
    // Groups and Users:
    // - Famous Actors
    //  - Participants are: Bud Spencer, Louis De Funes, Heinz Erhard, Bruce Willis
    // - Super Heroes
    //  - Leader is: Bruce Willis
   ...
   */
  // TestManager.wait = function (done, millis) {
  //   var timeout = false;
  ...
  //     return timeout;
  //   }, 'TestManager.wait() failed.', millis + 250);
  // };

  /*
  Waits until the asynchronous call is executed.
   */
