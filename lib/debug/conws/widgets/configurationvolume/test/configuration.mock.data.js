        ...
        responseText: {
          results: [
            ...
            },
            {
              "id": 80000,
              "name": 'A long Shortcut name that spans multiple lines',
              "displayName": 'A long Shortcut name that spans multiple lines'
            },
            {
              "id": 90000,
              "name": 'A really long Shortcut name that spans so many lines.  The quick brown fox jumps over the fence with missing letter g.  The quick brown fox jumps over the lazy dog.  That\'s complete English alphabet.  What about pangrams for other languages?',
              "displayName": 'A really long Shortcut name that spans so many lines.  The quick brown fox jumps over the fence with missing letter g.  The quick brown fox jumps over the lazy dog.  That\'s complete English alphabet.  What about pangrams for other languages?'
            },
            {
              "id": 2003,
              "name": 'My Personal Workspace',
              "displayName": 'My Personal Workspace'
            },
            {
              "type": 141,
              "name": 'Enterprise',
