...
csui.define(['require', 'csui/lib/underscore', 'csui/lib/jquery', 'csui/lib/jquery.parse.param',
  'csui/lib/jquery.mockjax', 'json!./conws.child.tool.mask.data.json'
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v1/objectsocialinfo?csid=98022&includes=comment_count',
        type: 'get',
        responseTime: 0,
        responseText: mockjson.response_nodes_workspace_comment
      }));
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v1/objectsocialinfo?csid=98026&includes=comment_count',
        type: 'get',
        responseTime: 0,
        responseText: mockjson.response_nodes_outside_comment
      }));
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v1/objectsocialinfo?csid=30592&includes=comment_count',
        type: 'get',
        responseTime: 0,
        responseText: mockjson.response_nodes_outside_comment
      }));
