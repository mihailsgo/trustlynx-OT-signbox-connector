/**
 * Created by stefang on 12.01.2016.
 */
csui.define(['csui/lib/jquery', 'csui/lib/jquery.mockjax'], function ($, mockjax) {
    ...
    enable: function () {
      ...
      this.mocks.push(mockjax({
        ...
        responseText: {
          ...
          }, "results": {"direct_open": false, "id": 349279, sub_folder_id: 25981}
        }
      }));
      this.mocks.push(mockjax({
			...
			"349279": {
			  "data": {
				"addcategory": {
				  ...
				  "content_type": "",
				  "form_href": "",
				  "href": "/api/v2/nodes/349279/categories",
				  "method": "POST",
				  "name": "Add Category"
				},
				"AddRMClassifications": {
				  ...
				  "form_href": "",
				  "href": "/api/v2/nodes/349279/rmclassifications",
				  "method": "POST",
      ...
      this.mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/25981?*',
        responseTime: 0,
        responseText: {
          "links": {
            "self": {
              "body": "",
              "content_type": "",
              "href": "\/api\/v2\/nodes\/25981?expand=properties%7Bcreate_user_id%2Cowner_user_id%7D&actions&perspective",
              "method": "GET",
              "name": ""
            }
          },
          "results": {
            "actions": {
              "audit": {
                ...
                "content_type": "",
                "form_href": "",
                "href": "\/api\/v1\/nodes\/25981\/audit?limit=1000",
                "method": "GET",
                "name": "Audit"
              },
              "copy": {
                "body": "",
                "content_type": "",
                "form_href": "\/api\/v1\/forms\/nodes\/copy?id=25981",
                "href": "\/api\/v1\/nodes",
                "method": "POST",
                "name": "Copy"
              },
              ...
              "makefavorite": {
                ...
                "content_type": "",
                "form_href": "",
                "href": "\/api\/v2\/members\/favorites\/25981",
                "method": "POST",
                "name": "Add to Favorites"
              },
              "more": {
              ...
              "move": {
                "body": "",
                "content_type": "",
                "form_href": "\/api\/v1\/forms\/nodes\/move?id=25981",
                "href": "\/api\/v1\/nodes\/25981",
                "method": "PUT",
                "name": "Move"
              },
              ...
              "rename": {
                "body": "",
                "content_type": "",
                "form_href": "\/api\/v1\/forms\/nodes\/rename?id=25981",
                "href": "\/api\/v1\/nodes\/25981",
                "method": "PUT",
                "name": "Rename"
              }
            ...
            "data": {
              ...
              "properties": {
                ...
                "modify_date": "2016-01-14T12:32:30",
                "modify_user_id": 1000,
                "name": "Test Contract Workspace Parent 001",
                "name_multilingual": {"en_US": "Test Contract Workspace Parent 001"},
                "owner_group_id": 1001,
                "owner_user_id": 1000,
                "owner_user_id_expand": {
                  "birth_date": null,
  ...
  DataManager.testMaterial = {
    ...
    enable: function () {
      ...
      this.mocks.push(mockjax({
        ...
        //url: '//server/otcs/cs/api/v2/nodes/538888?expand=properties%7Boriginal_id%2Cparent_id%2Cvolume_id%2Ccreate_user_id%2Cmodify_user_id%2Cowner_user_id%2Creserved_user_id%7D&fields=properties&actions=addcategory&actions=addversion&actions=default&actions=open&actions=browse&actions=copy&actions=delete&actions=download&actions=edit&actions=favorite&actions=nonfavorite&actions=rename&actions=move&actions=properties&actions=reserve&actions=unreserve'
        //url: '//server/otcs/cs/api/v2/nodes/538888?expand=properties%7Bcreate_user_id%2Cowner_user_id%7D&actions',
        responseTime: 0,
        responseText: {
          "links": {
            "data": {
