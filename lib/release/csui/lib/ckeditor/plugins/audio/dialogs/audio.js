				...
				[
					{
						...
						children : [
							...
							},
							{
								type : 'button',
								id : 'browse',
								style : 'display:inline-block;margin-top:8px;margin-right:16px;',
								filebrowser :
								{
									action : 'Browse',
									target: 'info:poster',
						...
						children : [
							{
								...
								commit : commitSrc,
								validate : CKEDITOR.dialog.validate.notEmpty(lang.SourceAudioRequired),
								setup : loadSrc
							},
							{
								type : 'button',
								id : 'browse',
								hidden : 'true',
								style : 'display:inline-block;margin-top:60px;margin-right:16px',
								filebrowser :
								{
									action : 'Browse',
									target: 'info:src0',
